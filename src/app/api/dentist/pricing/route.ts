...
import { updatePricingSchema } from "@/lib/validators/pricing";
...
/**
 * PUT /api/dentist/pricing
 * Update pricing ranges (Pro/Premium only)
 */
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    if (!entitlements.canEditPricing) {
    ...
    const [updated] = await db
      .update(dentists)
      .set({
        pricingRanges: validated.pricingRanges as any,
